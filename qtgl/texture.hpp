...
class GLTexture {
 public:
  ...
  virtual TexCoord interpolateTexCoord(Triangle2& t, double alpha, double beta, double gamma) = 0;
...
class InterpolateGLTexture : public GLTexture {
 public:
  ...
  TexCoord interpolateTexCoord(Triangle2& t, double alpha, double beta, double gamma) {
  ...
  纹理坐标插值 - 基础版
  */
  TexCoord basicInterpolcate(Triangle2& t, double alpha, double beta, double gamma) {
  ...
  */
  TexCoord prespectiveCorrectInterpolate(Triangle2& t, double alpha, double beta, double gamma) {
